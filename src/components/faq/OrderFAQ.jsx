...
const OrderFAQ = ({ setIndex, currentIndex }) => {
    return (
        <Pane borderBottom>
            <Accordion
                index={1}
                ...
                header={
                    ({ handleClick }) => (
                        <Pane textAlign='center' onClick={handleClick}>
                            {currentIndex === 1 && <Icon icon='caret-right' />}
                            <Strong size={currentIndex === 1 ? 600 : 500}>Order</Strong>
                            {currentIndex === 1 && <Icon icon='caret-left' />}
                        </Pane>
                    )
                }
                content={
