...
const ProductFAQ = ({ setIndex, currentIndex }) => {
    return (
        <Pane>
            <Accordion
                index={2}
                ...
                header={
                    ({ handleClick }) => (
                        <Pane textAlign='center' onClick={handleClick} cursor='pointer'>
                            {currentIndex === 2 && <Icon icon='caret-right' />}
                            <Strong size={currentIndex === 2 ? 600 : 500}>Product</Strong>
                            {currentIndex === 2 && <Icon icon='caret-left' />}
                        </Pane>
                    )
                }
                content={
