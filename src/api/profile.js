...
import { updateInfoMutation, confirmVerificationMutation, subscribeNewsletterMutation, changeShippingAddressMutation, deleteProfileMutation } from '../mutations/profile.mutation'
...
export default {
  ...
  changeAddress: (id, select) => privateQuery({ query: changeShippingAddressMutation(id, select) }),
